...
ALLOWED_CHANGED_PATHS = frozenset(
    {
        ...
        "tests/run_host_realization_r1_focal.py",
        ...
        "tests/test_host_realization_v1.py",
        ...
        "tev_script/semantic_host_realization_v1.py",
        ...
        "tools/validate_host_realization_v1.py",
