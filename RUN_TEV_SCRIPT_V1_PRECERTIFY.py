...
def require_gate(
    ...
    *,
    ...
    if reject_skip and "SKIPPED_" in stdout:
        fail(label, "UNEXPECTED_SKIP", completed)
...
def main() -> int:
    ...
    if ancestry.returncode != 0:
        fail("V0_2_ORACLE_ANCESTRY", "FAIL")
    print("V0_2_ORACLE_ANCESTRY=PASS")

    closure = require_gate(
        "TEV_SCRIPT_V1_FRONTEND_CLOSURE_GATE",
        [sys.executable, str(ROOT / "RUN_TEV_SCRIPT_V1_FRONTEND_CLOSURE.py")],
        (
    ...
    if "skipped=" in closure.lower():
        fail("TEV_SCRIPT_V1_FRONTEND_CLOSURE_GATE", "TEST_SKIP_DETECTED")

    require_gate(
        "TEV_SCRIPT_IR_V3_CSHARP_PORTABLE_SURFACE_GATE",
        python_tool("validate_ir_v3_csharp_portable_surface.py"),
        (
    ...
    require_gate(
        ...
        python_tool("validate_ir_v3_cross_runtime_parity.py"),
        (
    ...
    require_gate(
        ...
        python_tool("validate_ir_v3_checkpoint_cross_runtime.py"),
        (
    ...
    require_gate(
        ...
        python_tool("validate_ir_v3_browser_wasm.py"),
        (
    ...
    require_gate(
        ...
        python_tool("validate_ir_v3_wasi.py"),
        (
    ...
    require_gate(
        ...
        python_tool("validate_ir_v3_signed_update.py"),
        (
    ...
    require_gate(
        ...
        python_tool("validate_ir_v3_browser_signed_update.py"),
        (
    ...
    require_gate(
        ...
        python_tool("validate_ir_v3_wasi_signed_update.py"),
        (
    ...
    portable = require_gate(
        ...
        [sys.executable, str(ROOT / "RUN_PORTABLE_CONFORMANCE.py")],
        (),
        reject_skip=False,
    )
    ...
    evidence = {
        "schema": "TEV_SCRIPT_V1_PRECERTIFY_RECEIPT_V5",
        "branch": branch,
        "commit": head,
        "tree": tree,
